...
public class SimpleVideoStream extends Activity implements
	...
	public void onPrepared(MediaPlayer mp) {
		...
		if(position!=null&&!position.equals("")&&!position.equals("0")){
	...
	public void onCompletion(MediaPlayer mp) {
		stop();
		//if (mShouldAutoClose) {
			wrapItUp(RESULT_OK,mVideoView.getCurrentPosition()+"");
		//}
	}
	...
	public boolean onError(MediaPlayer mp, int what, int extra) {
		...
		wrapItUp(RESULT_CANCELED, mVideoView.getCurrentPosition()+"");
		return true;
	}
